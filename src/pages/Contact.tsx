  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="通过官方社交媒体关注陈佳，或发送合作邀请至 contact@chenjia-music.com。" />
        ...
        <meta property="og:url" content="https://kei-music.com/contact" />
        <link rel="canonical" href="https://kei-music.com/contact" />
      </Helmet>
      ...
      <div className="min-h-screen py-16 md:py-24">
        <div className="container mx-auto px-4 max-w-2xl">
          ...
          <header className="text-center mb-8">
            ...
            <p className="text-base md:text-lg text-muted-foreground max-w-xl md:max-w-2xl mx-auto mt-6">
          ...
          <div className="">
            ...
            <div className="mb-1">
              ...
              <a 
                href="mailto:business@chenjia-music.com" 
                className="
                  inline-flex items-center
                  w-full max-w-md
                  text-primary font-medium rounded-lg
                "
              >
                business@chenjia-music.com
              </a>
            </div>
